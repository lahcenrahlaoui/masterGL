...
var place_attr = { "fill": "skyblue", "stroke": "skyblue", "stroke-width": "2" };
var trans_attr = { "fill": "141414", "stroke": "141414", "stroke-width": "2" };
var token_attr = { "fill": "black", "stroke": "black", "stroke-width": "0" };
var drag_on_attr = { "stroke": "red", "stroke-width": "4" };
var drag_off_attr = { "stroke": "skyblue", "stroke-width": "2" };
var arrow_head_attr = { "stroke": "skyblue", "stroke-width": "3", "arrow-end": "block-wide-long" };
...
function NewPlace(a,x, y,j , t)
{
    next_key(Places)
    AddPlace("P" + a, x, y, j , t);
}

function NewTransition(x, y , t) {
    AddTransition("T" + next_key(Trans) , x, y , t);
}
...
function AddPlace(key, x, y, tokens,t){
    ...
    place.caption = draw_text(key + " " + t, x, y);
...
function AddTransition(key, x, y , t)
{
    ...
    transition.y = y;
    transition.key = key;
    transition.caption = draw_text(key + " " + t, x, y);
