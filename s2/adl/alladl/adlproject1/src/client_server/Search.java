...
public class Search extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(ss == "informatique"){
           query3="SELECT * FROM student where firstName='"+jTextField1.getText()+"' ";
        }else{
            query3="SELECT * FROM et where firstName ='"+jTextField1.getText()+"' ";
        }
            ...
            jTextField4.setText(String.valueOf(average));
