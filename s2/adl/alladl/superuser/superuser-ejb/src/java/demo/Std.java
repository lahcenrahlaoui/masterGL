...
@NamedQueries({
    ...
    , @NamedQuery(name = "Std.findByDegree", query = "SELECT s FROM Std s WHERE s.degree = :degree")
    , @NamedQuery(name = "Std.findByYear", query = "SELECT s FROM Std s WHERE s.year = :year")})
