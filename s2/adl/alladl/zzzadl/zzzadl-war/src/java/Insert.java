...
public class Insert extends HttpServlet {
    ...
    out.println("<div class=\"login-form\">\n" +
                ...
                "        <h6 class=\"text-center\">You have added a persone</h6>       \n" +
                "        <div class=\"form-group parent\">\n" +
                "            <div class=\"item\">ID</div><div class=\"item\">"+id+"</div>\n" +
                "        </div>\n" +
                "      \n" +
                "         <div class=\"form-group parent\">\n" +
                "            <div class=\"item\">First Name : </div><div class=\"item\">"+firstName+"</div>\n" +
                "        </div>\n" +
                "       <div class=\"form-group parent\">\n" +
                "             <div class=\"item\">Last Name : </div><div class=\"item\">"+lastName+"</div>\n" +
                "        </div>\n" +
                "       <div class=\"form-group parent\">\n" +
                "             <div class=\"item\">Average : </div><div class=\"item\">"+average+"</div>\n" +
                "        </div>\n" +
                "       <div class=\"form-group parent\">\n" +
                "             <div class=\"item\">Degree : </div><div class=\"item\">"+degree+"</div>\n" +
                "        </div>\n" +
                "       <div class=\"form-group parent\">\n" +
                "             <div class=\"item\">Year : </div><div class=\"item\">"+year+"</div>\n" +
                "        </div>\n" +
                "        <div class=\"form-group \">\n" +
                "            <a href=\"insert.jsp\">Add An Other student</a>\n" +
